...
/**
  * Sample of decoupling domain from data model. This allow us to handle schema evolution easily
  */
...
/**
  * There is the place where we put all the domain related stuff
  */
object DomainModel {
