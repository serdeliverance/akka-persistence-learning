...
object MultiplePersisting extends App {
  ...
  /*
    ...
    - a tax record for the fisical authority
  ...
  val system = ActorSystem("MultiplePersisting")
  val taxAuthority = system.actorOf(Props[TaxAuthority], "HMRC")
  val accountant = system.actorOf(DiligentAccountant.props("UK12331_32", taxAuthority), "diligentAccountant")
